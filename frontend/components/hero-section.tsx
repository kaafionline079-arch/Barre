  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-16 md:pt-20 overflow-hidden">
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-primary/15 rounded-full blur-3xl animate-pulse delay-1000" />
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <AnimateInView variant="fade-right" delay={0} className="order-2 md:order-1">
              <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-medium animate-pulse-glow">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-foreground mb-6 text-balance leading-tight">
                Hi, I&apos;m <span className="bg-gradient-to-r from-primary via-primary to-primary/70 bg-clip-text text-transparent animate-gradient-text">Mohamed Barre</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 mb-8">
                <Button size="lg" className="w-full sm:w-auto group shadow-lg shadow-primary/25" asChild>
            ...
            <AnimateInView variant="fade-left" delay={200} className="order-1 md:order-2">
              <div className="relative w-full aspect-square max-w-md mx-auto hero-image-float">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/30 to-primary/5 rounded-3xl rotate-6 scale-105 animate-float-slow" />
                <div className="relative w-full h-full rounded-3xl overflow-hidden border-2 border-secondary/20 shadow-2xl shadow-primary/20">
